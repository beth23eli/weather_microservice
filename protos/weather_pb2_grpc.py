...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/weather_pb2_grpc.py depends on'
...
class WeatherServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetWeather = channel.unary_unary(
                ...
                request_serializer=protos_dot_weather__pb2.WeatherRequest.SerializeToString,
...
def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetWeather': grpc.unary_unary_rpc_method_handler(
                    servicer.GetWeather,
                    request_deserializer=protos_dot_weather__pb2.WeatherRequest.FromString,
...
class WeatherService(object):
    ...
    def GetWeather(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weather.WeatherService/GetWeather',
            protos_dot_weather__pb2.WeatherRequest.SerializeToString,
